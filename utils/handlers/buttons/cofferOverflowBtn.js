...
async function overFlowBtnHandler(interaction) {
   ...
   try {
      if (member.roles.cache.has(overflowRoleId)) {
         ...
         await interaction.reply({ embeds: [gifEmbed], content: '<:Warning:1395170298197966981> Your in game coffer deposits are now treated as **withdrawals from your personal overflow** and your coffer withdrawals as **deposits to your personal overflow!**', flags: MessageFlags.Ephemeral });
      }
   } catch (error) {
